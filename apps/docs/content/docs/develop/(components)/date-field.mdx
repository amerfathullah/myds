...
<Tabs items={["Preview", "Code"]} defaultValue="Preview">
  <Tab value="Preview">
    <div className="not-prose flex flex-col gap-3 items-center">
      <div className="flex flex-col gap-1.5">
        <Label htmlFor="date-field-uncontrolled">Uncontrolled</Label>
        <DateField id="date-field-uncontrolled" defaultValue={NOW} />
      </div>
      <div className="flex flex-col gap-1.5">
        <Label htmlFor="date-field-controlled">Controlled</Label>
...
<Tabs items={["Preview", "Code"]} defaultValue="Preview">
  <Tab value="Preview">
    <div className="not-prose flex justify-center">
      <div className="flex flex-col gap-1.5">
        <Label htmlFor="date-field-disabled">Date of birth</Label>
...
<Tabs items={["Preview", "Code"]} defaultValue="Preview">
  <Tab value="Preview">
    <div className="not-prose flex justify-center">
      <div className="flex flex-col gap-1.5">
        <Label htmlFor="date-field-invalid">Date of birth</Label>
