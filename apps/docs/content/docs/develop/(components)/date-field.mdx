...
<Tabs items={["Preview", "Code"]} defaultValue="Preview">
  <Tab value="Preview" className="not-prose flex justify-center">
    <div className="flex flex-col gap-2">
      <Label htmlFor="date-field" size="small">Date of birth</Label>
...
<Tabs items={["Preview", "Code"]} defaultValue="Preview">
  <Tab value="Preview">
    <div className="not-prose flex flex-col items-center gap-3">
      <div className="flex flex-col gap-2">
        <Label htmlFor="date-field-small" size="small">Date of birth</Label>
        <DateField id="date-field-small" size="small" />
      </div>
      <div className="flex flex-col gap-2">
        <Label htmlFor="date-field-medium" size="medium">Date of birth</Label>
        <DateField id="date-field-medium" size="medium" />
      </div>
      <div className="flex flex-col gap-2">
        <Label htmlFor="date-field-large" size="large">Date of birth</Label>
...
<Tabs items={["Preview", "Code"]} defaultValue="Preview">
  <Tab value="Preview">
    <div className="not-prose flex flex-col gap-3 items-center">
      <div className="flex flex-col gap-2">
        <Label htmlFor="date-field-uncontrolled" size="small">Uncontrolled</Label>
        <DateField id="date-field-uncontrolled" defaultValue={NOW} />
      </div>
      <div className="flex flex-col gap-2">
        <Label htmlFor="date-field-controlled" size="small">Controlled</Label>
...
<Tabs items={["Preview", "Code"]} defaultValue="Preview">
  <Tab value="Preview">
    <div className="not-prose flex justify-center">
      <div className="flex flex-col gap-2">
        <Label htmlFor="date-field-disabled" size="small">Date of birth</Label>
...
<Tabs items={["Preview", "Code"]} defaultValue="Preview">
  <Tab value="Preview">
    <div className="not-prose flex justify-center">
      <div className="flex flex-col gap-2">
        <Label htmlFor="date-field-invalid" size="small">Date of birth</Label>
