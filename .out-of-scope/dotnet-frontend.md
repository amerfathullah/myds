...
Upstream reached the same conclusion and marked its request `wontfix`, proposing a React + .NET Core boilerplate instead. That boilerplate is itself out of scope; see [backend-boilerplates.md](backend-boilerplates.md).
